...
from .models.microsoft_app_configuration import ApiKey, ApiKeyListResult, CheckNameAvailabilityParameters, ConfigurationStore, DeletedConfigurationStore, KeyValue, NameAvailabilityStatus, OkResponse, OperationDefinitionListResult, PrivateEndpointConnection, PrivateLinkResource, RegenerateKeyParameters, Replica, ResourceListResult, Snapshot


class ConfigurationStoresOperations(Protocol):
  def get(self, subscriptionId: str, resourceGroupName: str, configStoreName: str, **kwargs: Any) -> ConfigurationStore: ...
  def create(self, subscriptionId: str, resourceGroupName: str, configStoreName: str, **kwargs: Any) -> LROPoller[ConfigurationStore]: ...
  def update(self, subscriptionId: str, resourceGroupName: str, configStoreName: str, **kwargs: Any) -> LROPoller[ConfigurationStore]: ...
  def delete(self, subscriptionId: str, resourceGroupName: str, configStoreName: str, **kwargs: Any) -> LROPoller[None]: ...
  def listByResourceGroup(self, subscriptionId: str, resourceGroupName: str, **kwargs: Any) -> ItemPaged[Any]: ...
  def list(self, subscriptionId: str, **kwargs: Any) -> ItemPaged[Any]: ...
  def listKeys(self, subscriptionId: str, resourceGroupName: str, configStoreName: str, **kwargs: Any) -> ItemPaged[Any]: ...
  def regenerateKey(self, subscriptionId: str, resourceGroupName: str, configStoreName: str, regenerate_key_parameters: RegenerateKeyParameters, **kwargs: Any) -> ApiKey: ...

class DeletedConfigurationStoresOperations(Protocol):
  def getDeleted(self, subscriptionId: str, location: str, configStoreName: str, **kwargs: Any) -> DeletedConfigurationStore: ...
...
class PrivateEndpointConnectionsOperations(Protocol):
  def get(self, subscriptionId: str, resourceGroupName: str, configStoreName: str, privateEndpointConnectionName: str, **kwargs: Any) -> PrivateEndpointConnection: ...
  def createOrUpdate(self, subscriptionId: str, resourceGroupName: str, configStoreName: str, privateEndpointConnectionName: str, **kwargs: Any) -> LROPoller[PrivateEndpointConnection]: ...
  def delete(self, subscriptionId: str, resourceGroupName: str, configStoreName: str, privateEndpointConnectionName: str, **kwargs: Any) -> LROPoller[None]: ...
  def listByConfigurationStore(self, subscriptionId: str, resourceGroupName: str, configStoreName: str, **kwargs: Any) -> ItemPaged[Any]: ...

class PrivateLinkResourcesOperations(Protocol):
  def get(self, subscriptionId: str, resourceGroupName: str, configStoreName: str, groupName: str, **kwargs: Any) -> PrivateLinkResource: ...
  def listByConfigurationStore(self, subscriptionId: str, resourceGroupName: str, configStoreName: str, **kwargs: Any) -> ItemPaged[Any]: ...

class KeyValuesOperations(Protocol):
  def get(self, subscriptionId: str, resourceGroupName: str, configStoreName: str, keyValueName: str, **kwargs: Any) -> KeyValue: ...
  def createOrUpdate(self, subscriptionId: str, resourceGroupName: str, configStoreName: str, keyValueName: str, **kwargs: Any) -> LROPoller[KeyValue]: ...
  def delete(self, subscriptionId: str, resourceGroupName: str, configStoreName: str, keyValueName: str, **kwargs: Any) -> LROPoller[None]: ...

class ReplicasOperations(Protocol):
  def get(self, subscriptionId: str, resourceGroupName: str, configStoreName: str, replicaName: str, **kwargs: Any) -> Replica: ...
  def create(self, subscriptionId: str, resourceGroupName: str, configStoreName: str, replicaName: str, **kwargs: Any) -> LROPoller[Replica]: ...
  def delete(self, subscriptionId: str, resourceGroupName: str, configStoreName: str, replicaName: str, **kwargs: Any) -> LROPoller[None]: ...
  def listByConfigurationStore(self, subscriptionId: str, resourceGroupName: str, configStoreName: str, **kwargs: Any) -> ItemPaged[Any]: ...

class SnapshotsOperations(Protocol):
  def get(self, subscriptionId: str, resourceGroupName: str, configStoreName: str, snapshotName: str, **kwargs: Any) -> Snapshot: ...
  def create(self, subscriptionId: str, resourceGroupName: str, configStoreName: str, snapshotName: str, **kwargs: Any) -> LROPoller[Snapshot]: ...
...
class ModelsByName(TypedDict):
    api_key: type[ApiKey]
    api_key_list_result: type[ApiKeyListResult]
    check_name_availability_parameters: type[CheckNameAvailabilityParameters]
    configuration_store: type[ConfigurationStore]
    deleted_configuration_store: type[DeletedConfigurationStore]
    key_value: type[KeyValue]
    name_availability_status: type[NameAvailabilityStatus]
    ok_response: type[OkResponse]
    operation_definition_list_result: type[OperationDefinitionListResult]
    private_endpoint_connection: type[PrivateEndpointConnection]
    private_link_resource: type[PrivateLinkResource]
